...
# pass or fail
download_speed_pass_or_fail = "Download speed is more than 50 Mbps.\nAdvised Verdict: PASS" if download_speed /1024 /1024 >= 50 else "Download speed is less than 50 Mbps.\nAdvised Verdict: FAIL"
upload_speed_pass_or_fail = "Upload speed is more than 10 Mbps.\nAdvised Verdict: PASS" if upload_speed /1024 /1024 >= 10 else "Upload speed is less than 10 Mbps.\nAdvised Verdict: FAIL"
